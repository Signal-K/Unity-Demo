namespace GameCreator.UIComponents
{
	...
	[AddComponentMenu("")]
    public class ActionuGUINumVariableToText : IAction
    {
	    ...
	    public static new string NAME = "UI/uGUI/Number Variable To Text";
	    private const string NODE_TITLE = "Number Variable To Text";
