namespace GameCreator.UIComponents
{
	...
	[AddComponentMenu("")]
	public class ActionCrossFadeTMPPanel : IAction
	{
		...
		public static new string NAME = "UI/Elements/Crossfade TMP Panel";
		private const string NODE_TITLE = "Crossfade {0} TMP Panel";
