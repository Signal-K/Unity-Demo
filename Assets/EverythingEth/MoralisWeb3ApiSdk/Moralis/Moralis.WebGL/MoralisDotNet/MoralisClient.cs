...
namespace Moralis.WebGL
{
    public class MoralisClient : IDisposable
    {
        ...
        {
            get => Moralis.WebGL.Platform.Services.ServiceHub<MoralisUser>.ManifestData;
            set
            {
                Moralis.WebGL.Platform.Services.ServiceHub<MoralisUser>.ManifestData = value;
                Moralis.WebGL.Platform.Services.MutableServiceHub<MoralisUser>.ManifestData = value;
            }
        }
    }
}
