namespace GameCreator.UIComponents
{
	...
	[AddComponentMenu("")]
	public class ActionRotateCanvasIn : IAction
	{
     ...
        public Vector3 AnimInPosition;
        ...
        public override IEnumerator Execute(GameObject target, IAction[] actions, int index)
        {
            ...
            switch (this.alignment)
                {
                    case ALIGN.Top:
                    animpanel.pivot = new Vector2(0.0f, 1f);

                    rotation = new Vector3(90f, 0f, 0f);
                    rotation1 = Quaternion.Euler(rotation);
        ...
        public static new string NAME = "UI/Canvas/Rotate Canvas Panel In";
		private const string NODE_TITLE = "Rotate Canvas Panel In";
        ...
        public override void OnInspectorGUI()
		{
            ...
            EditorGUILayout.PropertyField(this.spAlignment, new GUIContent("Rotate in from"));
            EditorGUILayout.Space();
