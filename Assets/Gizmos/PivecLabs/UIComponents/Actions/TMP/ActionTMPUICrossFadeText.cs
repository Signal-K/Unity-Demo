namespace GameCreator.UIComponents
{
	...
	public class ActionTMPUICrossFadeText : IAction
	{
        ...
        public override IEnumerator Execute(GameObject target, IAction[] actions, int index)
        {
	        ...
	        text = canvasText.GetComponent<TextMeshProUGUI>();
		...
		public static new string NAME = "UI/TMP/Cross Fade TMP Text";
		private const string NODE_TITLE = "Cross Fade TMP Text";
        ...
        public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.PropertyField(this.spcanvas, new GUIContent("TMP Text"));
